...
const lembretes = [
  ...
  { id: 3, hora: '18:00', titulo: 'Lavar a tatuagem', feito: false },
  { id: 4, hora: '22:00', titulo: 'Aplicar pomada', feito: false },
];

const dicas = [
  { icon: 'water-outline', texto: 'Hidrate bem a pele hoje' },
  { icon: 'sunny-outline', texto: 'Evite exposição ao sol' },
  { icon: 'shirt-outline', texto: 'Use roupas folgadas sobre a área' },
];
      ...
      <SafeAreaView style={styles.safe}>
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.lembretesContainer}>
            {lembretes.map((l) => (
              <View key={l.id} style={[styles.lembrete, l.feito && styles.lembreteFeito]}>
            ...
            {dicas.map((d, i) => (
              <View key={i} style={styles.dica}>
                <View style={styles.dicaIcon}>
                  <Ionicons name={d.icon as any} size={18} color="#FF0000" />
                </View>
...
const styles = StyleSheet.create({
  ...
  lembreteTitulo: { fontSize: 14, color: '#fff' },
  ...
  dicaTexto: { fontSize: 14, color: '#ccc', flex: 1 },
